...
export const AppSidebar = () => {
  ...
  const isActive = (url: string) => {
    return pathname === url || pathname.startsWith(url + "/dasshboard");
  };
          ...
          <SidebarMenuItem>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <SidebarMenuButton
                  size="lg"
                  className="h-12 px-4 rounded-lg data-[state=open]:text-sidebar-accent-foreground hover:bg-sidebar/50 transition-colors"
                >
                  ...
                  <div className="grid flex-1 text-left-sm leading-relaxed min-w-0">
              ...
              <DropdownMenuContent
                ...
                sideOffset={8}
              >
                <div className="flex items-center gap-3 px-3 py-4 bg-sidebar-accent/30 rounded-t-lg">
